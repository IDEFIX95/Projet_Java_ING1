...
public class HistoriqueDepot {
    ...
    /**
     * Méthode temporaire pour indiquer un type de déchet affiché dans le dashboard.
     * Tu peux la surcharger si tu ajoutes les types de déchets réellement associés au dépôt.
     */
    public String getTypeDechetPrincipal() {
        // ➕ Ici tu peux implémenter une logique réelle selon les types dans la BDD (ex: DAO ou cache)
        return "déchets";
    }
